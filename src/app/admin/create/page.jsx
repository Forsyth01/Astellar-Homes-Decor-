...
export default function CreateBlog() {
  ...
  const updateCategoryPostCount = async (categoryName) => {
    try {
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="hidden sm:block">
                  <h1 className="text-lg sm:text-xl font-bold text-gray-900">Create New Story</h1>
                  <p className="text-xs sm:text-sm text-gray-500">Share your design inspiration</p>
                </div>
                <div className="sm:hidden">
                  <h1 className="text-base font-bold text-gray-900">New Story</h1>
                </div>
              </div>
            </div>
